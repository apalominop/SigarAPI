...
public class LlaveUsuarioController {
	...
	@RequestMapping(value = "llaveausuario", method = RequestMethod.POST)
	public ResponseEntity<FileMessage> asignarLlaveAUsuario(@RequestBody LlaveUsuario llave) throws Exception {
		llaveUsuarioService.guardarLlavePorUsuario(llave);
		String message = "Se asignó Llave a Usuario exitosamente";
