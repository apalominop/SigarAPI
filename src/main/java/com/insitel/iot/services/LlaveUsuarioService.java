...
public class LlaveUsuarioService {
	...
	/**
	 * Método para asignar una Llave a un Usuario
	 * @param llave
	 * @return
	 * @throws Exception
	 */
	public LlaveUsuario guardarLlavePorUsuario(LlaveUsuario llave) throws Exception {
		return llaveUsuarioRepository.save(llave);
	}
